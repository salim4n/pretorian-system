      ...
      return (
        <div className="min-h-screen flex flex-col items-center justify-center ">
          <div className=" p-8 rounded shadow-md w-full max-w-lg bg-primary text-white">
            ...
            <p className="mb-4">
              Pour obtenir votre chatId Telegram, veuillez suivre les étapes suivantes :
            </p>
            <ol className="list-decimal list-inside mb-4">
              <li>
                Ouvrez Telegram et recherchez notre bot 
                <strong className="text-purple-300">
                    <Link href="https://t.me/PraetorionBot" target="_blank" rel="noopener noreferrer">
                        @PraetorionBot
                    </Link>
                </strong>.
              </li>
              <li>
                Cliquez sur le bouton ci-dessous pour générer un UUID unique.
              </li>
              <li>
                Copiez l'UUID généré et envoyez-le à notre bot sur Telegram.
              </li>
              <li>
                Cliquez sur le bouton "Vérifier UUID" pour confirmer que vous avez bien envoyé l'UUID au bot.
              </li>
            </ol>
            ...
            {uuid && (
              <>
                <p className="mt-4"><strong>Votre UUID :</strong> {uuid}</p>
                <Button
                    variant="secondary"
